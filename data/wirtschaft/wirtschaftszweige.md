...
- name: jahr
  ...
  short: Betriebe/Niederlassungen nach Wirtschaftszweige in der Stadt Konstanz seit 2008
  export_id: Berichtsjahr
- name: insgesamt
  type: int
  description: Insgesamt
  unit: Anzahl Betriebe/Niederlassungen
  export_id: Betriebe / Niederlassungen insgesamt
- name: bergbau_und_gewinnung_von_steinen_und_erden
  type: int
  description: Bergbau und Gewinnung von Steinen und Erden
  unit: Anzahl Betriebe/Niederlassungen
  short: Bergbau und Gewinnung v. Steinen und Erden
  export_id: Bergbau und Gewinnung von Steinen und Erden
- name: verarbeitendes_gewerbe
  type: int
...
- name: handel_und_instandhaltung_und_reparatur_von_kraftfahrzeugen
  ...
  export_id: Handel; Instandhaltung und Reparatur von Kraftfahrzeugen
- name: verkehr_und_lagerei
  type: int
  description: Verkehr und Lagerei
  unit: Anzahl Betriebe/Niederlassungen
  export_id: Verkehr und Lagerei
- name: gastgewerbe
  type: int
  description: Gastgewerbe
  unit: Anzahl Betriebe/Niederlassungen
  export_id: Gastgewerbe
- name: information_und_kommunikation
  type: int
  description: Information und Kommunikation
  unit: Anzahl Betriebe/Niederlassungen
  export_id: Information und Kommunikation
- name: baugewerbe_und_grundstuecks_und_wohnungswesen
  type: int
  description: Baugewerbe; Grundstücks- und Wohnungswesen
  unit: Anzahl Betriebe/Niederlassungen
  export_id: Baugewerbe; Grundstücks- und Wohnungswesen
- name: erziehung_und_unterricht_und_gesundheits_u_sozialwesen
  type: int
  description: Erziehung und Unterricht; Gesundheits- & Sozialwesen
  unit: Anzahl Betriebe/Niederlassungen
  export_id: Erziehung und Unterricht; Gesundheits- & Sozialwesen
- name: kunst_und_unterhaltung_und_erholung
  type: int
  description: Kunst, Unterhaltung und Erholung
  unit: Anzahl Betriebe/Niederlassungen
  export_id: Kunst, Unterhaltung und Erholung
- name: erbringung_von_sonstigen_dienstleistungen
  type: int
  description: Erbringung von sonstigen Dienstleistungen
  unit: Anzahl Betriebe/Niederlassungen
  export_id: Erbringung von sonstigen Dienstleistungen
---
Anmerkungen: 
...
- Niederlassung (bis 2017: „Betriebe“): Eine örtlich abgegrenzte Einheit, die einer Rechtlichen Einheit zugeordnet ist.
